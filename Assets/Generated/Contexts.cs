...
public partial class Contexts : Entitas.IContexts {
    ...
    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { game, input, meta, time }; } }
...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.PrimaryEntityIndex<GameEntity, int>(
            BoardId,
            game.GetGroup(GameMatcher.BoardId),
            (e, c) => ((BoardIdComponent)c).value));
    }
}

public static class ContextsExtensions {

    public static GameEntity GetEntityWithBoardId(this GameContext context, int value) {
        return ((Entitas.PrimaryEntityIndex<GameEntity, int>)context.GetEntityIndex(Contexts.BoardId)).GetEntity(value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>

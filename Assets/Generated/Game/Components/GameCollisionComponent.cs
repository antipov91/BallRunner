...
public partial class GameEntity {
    ...
    public void AddCollision(GameEntity newTargetInstance) {
        var index = GameComponentsLookup.Collision;
        var component = (CollisionComponent)CreateComponent(index, typeof(CollisionComponent));
        component.targetInstance = newTargetInstance;
        AddComponent(index, component);
    }

    public void ReplaceCollision(GameEntity newTargetInstance) {
        var index = GameComponentsLookup.Collision;
        var component = (CollisionComponent)CreateComponent(index, typeof(CollisionComponent));
        component.targetInstance = newTargetInstance;

...
public partial class TimeContext {
    ...
    public TimeEntity deltaTimeEntity { get { return GetGroup(TimeMatcher.DeltaTime).GetSingleEntity(); } }
    ...
    public TimeEntity SetDeltaTime(float newValue) {
        if (hasDeltaTime) {
...
public partial class TimeEntity {
    ...
    public DeltaTimeComponent deltaTime { get { return (DeltaTimeComponent)GetComponent(TimeComponentsLookup.DeltaTime); } }
    public bool hasDeltaTime { get { return HasComponent(TimeComponentsLookup.DeltaTime); } }

    public void AddDeltaTime(float newValue) {
        var index = TimeComponentsLookup.DeltaTime;
    ...
    public void RemoveDeltaTime() {
        RemoveComponent(TimeComponentsLookup.DeltaTime);
    }
}
...
public sealed partial class TimeMatcher {
    ...
    static Entitas.IMatcher<TimeEntity> _matcherDeltaTime;

    public static Entitas.IMatcher<TimeEntity> DeltaTime {
        get {
            if (_matcherDeltaTime == null) {
                var matcher = (Entitas.Matcher<TimeEntity>)Entitas.Matcher<TimeEntity>.AllOf(TimeComponentsLookup.DeltaTime);
